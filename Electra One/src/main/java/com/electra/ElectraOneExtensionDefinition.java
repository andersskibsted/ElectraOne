...
{
   private static final UUID DRIVER_ID = UUID.fromString("bec51086-3278-40bb-8a78-02224f8426df");
   
   public ElectraOneExtensionDefinition()
   {
   }
   ...
   @Override
   public ElectraOneExtension createInstance(final ControllerHost host)
   {
